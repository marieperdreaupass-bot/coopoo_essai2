public class miniboss extends Monstre {
    ...
    public miniboss() {
        // Appelle le constructeur de Monstre : name, pv, attaque, vitesse, resistance
        super("Le Chevalier Corrompu", 1500, 120, 70, 50);

        // Ajout d'objets spécifiques au miniboss
        this.objets.add(new Objet("Petite Potion", 400));
        this.objets.add(new Objet("Talisman de Force", 30));
    }

    // On peut ajouter une attaque spéciale unique au miniboss
    public void attaqueSpeciale(perso cible) {
        System.out.println(this.name + " lance son attaque spéciale 'Lame d'Ombre' !");
        int degatsSpeciaux = (int) (this.attaque * 1.5);
        cible.PV -= degatsSpeciaux;
        System.out.println("Dégâts critiques infligés : " + degatsSpeciaux);
    }
}
